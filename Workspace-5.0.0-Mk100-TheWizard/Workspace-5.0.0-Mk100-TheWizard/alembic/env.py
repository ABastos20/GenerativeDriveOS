"""Alembic environment configuration for JARVIS System.
...
# Import governance models to register with Base
...
# This allows us to use Docker container networking and secrets from .env
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        compare_type=True,  # Compare column types for better autogenerate
