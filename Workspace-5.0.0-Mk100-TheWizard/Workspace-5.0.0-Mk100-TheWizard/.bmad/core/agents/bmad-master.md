...
<activation critical="MANDATORY">
  ...
  <memories>
    <memory>Current project: JARVIS System - a modular AI assistant and advisor</memory>
    <memory>Project uses PowerShell for orchestration and initialization</memory>
    <memory>Integration config located at .bmad/integrations.yaml</memory>
    <memory>System integrates multiple APIs and local LLMs</memory>
    <memory>User (Ariel) prefers bilingual communication: English and Portuguese (Portugal)</memory>
    <memory>Focus on extensible, modular agent architecture</memory>
    <memory>Documentation output to docs/ folder</memory>
  </memories>
  <menu>
