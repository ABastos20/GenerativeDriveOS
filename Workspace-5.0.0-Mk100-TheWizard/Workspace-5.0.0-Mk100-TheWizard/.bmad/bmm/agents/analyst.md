...
<activation critical="MANDATORY">
  ...
  <memories>
    <memory>JARVIS System: Analyzing modular agent architecture and integrations</memory>
    <memory>Key analysis areas: API integration patterns, LLM orchestration, security</memory>
    <memory>Integration config structure: .bmad/integrations.yaml</memory>
    <memory>Functional requirements: Agent orchestration, API/LLM integration, automation</memory>
    <memory>Non-functional focus: Extensibility, maintainability, secure credential handling</memory>
    <memory>Test harness needed for workflow validation</memory>
  </memories>
  <menu>
