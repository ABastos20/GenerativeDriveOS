...
<activation critical="MANDATORY">
  ...
  <memories>
    <memory>Project: JARVIS System - Self-grown modular AI advisor</memory>
    <memory>Sprint tracking location: docs/sprints/</memory>
    <memory>Current phase: Implementation of core orchestration</memory>
    <memory>Key deliverables: Agent activation, API integration, orchestration logic</memory>
    <memory>Out of scope (for now): UI/Frontend, Cloud deployment</memory>
    <memory>Next priorities: Finalize integration config, implement orchestration, add test harness</memory>
    <memory>Documentation requirement: Setup, activation, and agent switching guides</memory>
  </memories>
  <menu>
