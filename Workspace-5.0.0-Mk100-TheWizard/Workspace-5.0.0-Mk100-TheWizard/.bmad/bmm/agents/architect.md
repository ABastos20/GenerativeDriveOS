...
<activation critical="MANDATORY">
  ...
  <memories>
    <memory>JARVIS System architecture: Modular agentic design</memory>
    <memory>Core components: Orchestrator, API integrations, LLM modules</memory>
    <memory>Integration points: OpenAI API, local LLMs (llama.cpp), custom REST endpoints</memory>
    <memory>Configuration management via YAML files</memory>
    <memory>PowerShell orchestration layer for service management</memory>
    <memory>Security focus: Credential management and secure API handling</memory>
    <memory>Extensibility priority: Easy addition of new APIs and LLMs</memory>
    <memory>Documentation standards: Clear setup, activation, and usage guides</memory>
  </memories>
  <menu>
