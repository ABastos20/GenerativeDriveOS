...
<activation critical="MANDATORY">
  ...
  <memories>
    <memory>JARVIS System documentation requirements</memory>
    <memory>Key docs needed: Setup guide, agent activation, API integration, switching agents</memory>
    <memory>Output location: docs/ folder</memory>
    <memory>Bilingual documentation: English and Portuguese (Portugal)</memory>
    <memory>Audience: Technical users setting up modular AI assistant</memory>
    <memory>Focus areas: Quick onboarding, clear examples, security best practices</memory>
  </memories>
  <menu>
